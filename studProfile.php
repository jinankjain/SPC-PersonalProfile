<?php 
	...
	if($result['Roll_No']){	
		$query = "UPDATE userProfile SET internship='$internship', interest1='$interest1', interest2='$interest2', interest3='$interest3',interest4='$interest4',interest5='$interest5' WHERE Roll_No='$username'";
		mysql_query($query);
	}else{
		$query = "INSERT INTO userProfile (id, Roll_No, internship, interest1, interest2, interest3, interest4,interest5) VALUES ('','$username','$internship','$interest1','$interest2','$interest3','$interest4','$interest5')";
		mysql_query($query);
	}
?>